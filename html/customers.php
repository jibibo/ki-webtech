...
$query = "INSERT INTO customers (first_name, last_name, email, password, address, zip, city, country) 
VALUES ('$fname', '$lname', '$email', '$password', '$address', '$zipcode', '$city', '$country')";
